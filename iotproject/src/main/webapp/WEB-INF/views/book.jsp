...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-inner">
	    <div class="box-header well" data-original-title="">
	        <h2><i class="glyphicon glyphicon-book"></i> Books </h2>
	        <div class="box-icon">
    ...
    <div class="box-content">
    	<div class="alert alert-info">
    	 	 <p style="text-align: justify;" > Internet of Things (IoT) refers to physical and virtual objects that have unique identities and are connected to the internet to facilitate intelligent applications that make energy, logistics, industrial control, retail, agriculture and many other domains "smarter". There are many books written on IOT. Here are list of those books are provided with their signatures.</p>    	</div>
			<table
				...
				<tbody>
					...
					<c:forEach items="${bookFormList}" var="book" >
						<tr>
							<td class="center">${book.intbookid }</td>
							<td class="center"><a href="${book.txtbookurl}" target="blank">${book.txtbookname}</a></td>
							<td class="center">${book.txtbookprice }</td>
							<td class="center">${book.txtbookauthor }</td>
							<td class="center">${book.txtpublishername }</td>
							<td class="center">${book.txtpublishdate }</td>
						</tr>
					</c:forEach> 
