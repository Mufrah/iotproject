...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-inner">
	    <div class="box-header well" data-original-title="">
	        <h2><i class="glyphicon glyphicon-book"></i> Conference </h2>
	        <div class="box-icon">
    ...
    <div class="box-content">
    	<div class="alert alert-info">
    	 	 <p style="text-align: justify;" > A conference is generally understood as a meeting of several people to discuss a particular topic. It is often confused with a convention, colloquia or symposium. No longer page limits, are timely, reviews not that detailed they believe on author’s proof but in journal reviewers do verify the proof. Author need to present it work in a conferences where discussion is performed on his works. His paper either accepted or rejected in conference and he/she can submit paper after correcting reviews in same conference after one year or in another conference. </p>
       	</div>
			<table
 ...
 -->
				...
				<tbody>
					...
					<c:forEach items="${conferenceFormsList}" var="conference" >
						<tr>
							<td class="center">${conference.intconferenceid }</td>
							<td class="center"><a href="${conference.txtconferenceurl }" target="blank">${conference.txtconferencename }</a></td>
							<td class="center">${conference.txtconferencedescription }</td>
							<%-- <td class="center">${conference.txtPaid }</td> --%>
						</tr>
					</c:forEach> 
