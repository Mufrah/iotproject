...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-inner">
	    <div class="box-header well" data-original-title="">
	        <h2><i class="glyphicon glyphicon-book"></i> Protocols </h2>
	        <div class="box-icon">
    ...
    <div class="box-content">
    	<div class="alert alert-info">
    	 	 <p style="text-align: justify;" > 
  				The emerging "Internet of Things" covers a huge range of industries and scales of devices/applications. Below we take a look at a few of the protocols that are helping to drive the topic forward.  	 	 
    	 	 </p>
			...
			<table
				...
				<tbody>
					...
					<c:forEach items="${tblprotocolList}" var="protocol" >
						<tr>
							<td class="center">${protocol.intprotocolid }</td>
							<td class="center">${protocol.txtprotocolname }</td>
							<td class="center">${protocol.txtprotocoldescription }</td>
						</tr>
					</c:forEach> 
