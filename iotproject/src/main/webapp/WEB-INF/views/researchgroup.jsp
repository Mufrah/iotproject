...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-content">
    	<div class="alert alert-info">
    	 	 ...
    	 	 Research centres and groups provide a focus for thematic research that can transcend school structures and facilitate interdisciplinary approaches. Mostly faculty member and senior research scientist leads a research group that includes a number of graduate student researchers and often involves undergraduate researchers.
    	 	 </p>	
			...
			<table
				...
				<tbody>
					...
					<c:forEach items="${researchGroupFormList}" var="researchgroup" >
						<tr>
							<td class="center">${researchgroup.intreseatchgroupid }</td>
							<td class="center"><a href="${researchgroup.txtresearchgroupurl }" target="blank">${researchgroup.txtreseacrgroupname }</a></td>
							<td class="center">${researchgroup.txtresearchgroupdescription }</td>
						</tr>
					</c:forEach> 
