...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-inner">
	    <div class="box-header well" data-original-title="">
	        <h2><i class="glyphicon glyphicon-book"></i> RFCs (Request for Comment) </h2>
	        <div class="box-icon">
    ...
    <div class="box-content">
    	<div class="alert alert-info">
				...
				It is a type of publication for Internet Society and Internet Engineering Task Force (IETF). It is official publication channel for IETF, IAF (Internet Architecture Board) and global community of computer researchers in general. It is principal technical development and standard setting bodies for the internet. It is like memorandum that describe methods, behaviors, research, or innovations. All these are authorized by engineers and computer scientists. These can be submitted either as peer review or simply to convert new concepts. IETF adopt some of proposal published as RFC as internet standards.
			</p>

				<!-- <b>RFCs Series</b>
				<ul>
					<li>BCP: Best current Practice</li>
					<li>FYI: For your Information, informational RFC is promoted by IETF.</li>
					<li>STD: Standard is highly maturity level of IETF </li>
				</ul> -->
			<p>RFC documents are static. If particular document is changed oor updated. It is require to submit again. It’ll retain its RFC number after becoming international standard. But when an international standard is updated it is STD number remain same. There are status assigned to RFC like:</p>
				<b>RFCs Status</b>
				<ul>
					<li>Informational: Some essential recognized RFC status can made informational</li>
					<li>Experimental: A draft which is unclear is designated as experimental</li>
					<li>Best current practice: All administrative documents and other documents considered as official get status of Best current practice </li>
					<li>Historic: When a document is obsolete by its new version or not considered interesting in current internet or removed from standard stack due to other reason than its status is set to historic </li>
					<li>Unknown: This status is used for very old RFCs or some of RFCs would not published at some day than their status is set to unknown </li>
			...
			<table
				...
				<tbody>
					...
					<c:forEach items="${tblrfcList}" var="rfc" >
						<tr>
							<td class="center">${rfc.intrfcid }</td>
							<td class="center"><a href="${rfc.txtrfcurl }" target="blank">${rfc.txtrfcname}</a>	</tr>
					</c:forEach> 
