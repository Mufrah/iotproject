...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-inner">
	    <div class="box-header well" data-original-title="">
	        <h2><i class="glyphicon glyphicon-book"></i> Standards </h2>
	        <div class="box-icon">
    ...
    <div class="box-content">
    	<div class="alert alert-info">
    	 	 <p style="text-align: justify;" > The emerging "Internet of Things" covers a huge range of industries and scales of devices/applications. Below we take a look at a few of  standards that are helping to drive the topic forward.
    	 	 </p>
			...
			<table
				...
				<tbody>
					...
					<c:forEach items="${tblstandardsList}" var="standard" >
						<tr>
							<td class="center">${standard.intstandardid }</td>
							<td class="center">${standard.txtstandardname }</td>
							<td class="center">${standard.txtstandarddescription }</td>
						</tr>
					</c:forEach> 
