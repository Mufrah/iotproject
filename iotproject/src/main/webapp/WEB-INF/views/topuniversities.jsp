...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="box-inner">
	    <div class="box-header well" data-original-title="">
	        <h2><i class="glyphicon glyphicon-book"></i> Research Group & Labs </h2>
	        <div class="box-icon">
    ...
    <div class="box-content">
    	<div class="alert alert-info">
    	 	 <p style="text-align: justify;" > The Times Higher Education World University Rankings 2015-2016 list the best global universities and are the only international university performance tables to judge world class universities across all of their core missions - teaching, research, knowledge transfer and international outlook.</p>    	</div>
			<table
				...
				<tbody>
					...
					<c:forEach items="${topUniversitiesFormList}" var="topuniversities" >
						<tr>
							<td class="center">${topuniversities.inttopuniversitiesid }</td>
							<td class="center"><a href="${topuniversities.txttopuniversitiesurl }" target="blank">${topuniversities.inttopuniversitiesname }</a></td>
							<td class="center">${topuniversities.txttopuniversitiesrank }</td>
							<td class="center">${topuniversities.texttopuniversitiesdescription }</td>
